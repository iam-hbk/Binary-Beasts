...
if ( /* $_SESSION["signed_in"] */false) {
    echo '<li>Profile<i class="fa fa-user-circle" aria-hidden="true"></i></li>';
} else {
    echo '<li><div class="login_button">LOGIN<i class="fa fa-user-circle" aria-hidden="true"></i></div></li>';
}
?>
