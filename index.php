<?php include "header.php"?>
  ...
  <section class="section2">
    ...
    <div class="info">
      <h1>Hot-lines</h1>
      <p>
      Reporting crime is a good first step toward justice. 
      Don't be paralyzed by fear; report injustice to keep our children,
      families, and friends safe in the future. It all starts with a phone call.
      CRIME-LINE connects you with specially trained professionals who follow legal 
  ...
  <section class="section2">
    <div class="info">
      <h1>Community</h1>
      <p>
      Reply, Post, and Scroll through our Community page to see if you can relate to some of the daily traumas 
  ...
  <section class="section1">
    ...
    <div class="info">
      <h1>Get Help</h1>
      <p>
      The willingness to heal is the first step toward healing. On the road to recovery, 
