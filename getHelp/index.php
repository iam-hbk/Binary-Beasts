...
<video  id="vid" width="500" height="500" preload="auto" autoplay src="videos/gethelpvideo.mp4">
<source src="movie.ogg" type="video/ogg">
</video>

  <!-- <video id="vid" width="500" height="500" controls autoplay>
  <source src="movie.mp4" type="videos/gethelpvideo.mp4">
  <source src="movie.ogg" type="video/ogg">
  </video> -->
...
<div class="container">
  <form action="index.php">
    <label for="fname" style="color:white">The name of the organisation</label>
